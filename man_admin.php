        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
           ...
           <div id="main" lass="container-fluid">
            <div id="block" class="container">
                <h3>Manager Admin</h3>
                <p>Welcome to the manager admin interface. Please select an option below</p>
                <div class="btn-group btn-group-justified">
                  ...
                  <div class="btn-group">
                    <button id="adminbutton" type="button" class="btn"><a href="discount.php">Discount/Charge</a></button>
                  </div>
                    <div class="btn-group">
                    <button id="adminbutton" type="button" class="btn"><a href="bill.php">Final Bill</a></button>
                  </div>
                 <div class="btn-group">
                    <button id="adminbutton" type="button" class="btn"><a href="newadmin.php">Add Employee/Manager</a></button>
                  </div>
                </div>
            </div>
        </div>
